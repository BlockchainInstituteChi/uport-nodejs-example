...
function registryEncodingToIPFS(hexStr) {
  console.log('-------------------------------------------- \r\n\r\n hexstr is ', hexStr, "\r\n\r\n-------------------------------------------- \r\n\r\n" )
  var sliced = '1220' + hexStr.slice(2);
  console.log('-------------------------------------------- \r\n\r\n sliced is ', sliced, "\r\n\r\n-------------------------------------------- \r\n\r\n" )
  var decoded = hex.decode(sliced);
  console.log('-------------------------------------------- \r\n\r\n decoded is ', decoded, "\r\n\r\n-------------------------------------------- \r\n\r\n" )
  var ret = base58.encode(decoded);
  console.log('-------------------------------------------- \r\n\r\n ret is ', ret, "\r\n\r\n-------------------------------------------- \r\n\r\n" )
  return ret;
}
...
function eaeDecode(encoded) {
  ...
  console.log('eaeDecode ran with ', encoded, ' and returned ', output)
  return output;
}
...
function UportLite() {
  ...
  function encodeFunctionCall(functionSignature, registrationIdentifier, issuer, subject) {
    console.log("functionSignature", functionSignature, "registrationIdentifier", registrationIdentifier,"issuer", issuer, "subject", subject)
  ...
  function callRegistry(registrationIdentifier, issuerId, subjectId, callback) {
    ...
    console.log('callRegistry lib triggered: ', 'registrationIdentifier', registrationIdentifier, "issuerId", issuerId, "subjectId", subjectId, "callback", callback)
    ...
    console.log('~~~~~') 
    console.log('payload_r: ', payload_r)
    console.log('params: ', [{ to: registryAddress, data: callString }, 'latest'])
    console.log('~~~~~')

    return http(payload_r, function (error, response) {
      console.log('payload_r returned', response)
  ...
  function fetchIpfs(ipfsHash, callback) {
    ...
    var payload = { uri: '' + ipfsGw + ipfsHash };
    console.log('ipfs hash payload is ', payload)
    return http(payload, callback);
  }
