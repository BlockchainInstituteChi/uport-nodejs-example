...
function SimpleSigner(hexPrivateKey) {
  ...
  return function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(data) {
      ...
      console.log("simplesigner", data)
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              var hashis = (0, _Digest.sha256)(data)
              console.log('hashis', JSON.stringify(hashis))
              console.log('hashishex', hashis.toString('hex'))

              _privateKey$sign = privateKey.sign(hashis), r = _privateKey$sign.r, s = _privateKey$sign.s, recoveryParam = _privateKey$sign.recoveryParam;
              console.log('_privateKey$sign', _privateKey$sign)
