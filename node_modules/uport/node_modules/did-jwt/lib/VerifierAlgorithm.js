...
console.log('*********** /uport/node_modules/did-jwt/lib/VerifierAlgorithm.js is in the running ***********')
...
function toSignatureObject(signature) {
  ...
  // console.log('toSignatureObject ran', signature, recoverable, rawsig, r, s, sigObj, sigObj.recoveryParam)
  return sigObj;
}
