...
var createJWT = exports.createJWT = function () {
  ...
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(payload, _ref) {
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        // console.log('createJWT context', _context)
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            console.log('body: ', {}, timestamps, payload, { iss: issuer })
            console.log('signer:', _extends3.default)
...
var verifyJWT = exports.verifyJWT = function () {
  ...
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(jwt) {
    ...
    console.log('verifyJWT', arguments)
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            console.log('************************************** vJWT case 0 ', aud, options.audience, normalizeDID(options.audience))
            aud = options.audience ? normalizeDID(options.audience) : undefined;
            console.log('** 8 jwt: ', jwt)
          ...
          case 21:
            console.log('** vJWT case 21 ')
            _context2.next = 27;
            break;

          case 23:
            console.log('** vJWT case 23 ')
          ...
          case 27:
            console.log('** vJWT case 27 ', { payload: payload, doc: doc, issuer: issuer, signer: signer, jwt: jwt })
            return _context2.abrupt('return', { payload: payload, doc: doc, issuer: issuer, signer: signer, jwt: jwt });

          case 30:
            console.log('** vJWT case 30 ')
          case 'end':
...
var resolveAuthenticator = exports.resolveAuthenticator = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(alg, mnidOrDid, auth) {
    console.log('resolveAuthenticator ran')
    var types, issuer, doc, authenticationKeys, authenticators;
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      console.log('ra regenerator ran')
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            console.log('rA case 0')
            console.log('+++++++++++++++++++++++ context 3 0: ', _context3)
          ...
          case 3:
            console.log('+++++++++++++++++++++++ context 3 3: ', _context3)
            console.log('rA case 3, mnidOrDid is ', mnidOrDid)
            issuer = normalizeDID(mnidOrDid);
            _context3.next = 6;
            return (0, _didResolver2.default)(issuer);

          case 6:
            console.log('+++++++++++++++++++++++ context 3 6: ', _context3)
            doc = _context3.sent;
            console.log('rA case 6', doc)
          ...
          case 9:
            console.log('rA case 9')
            console.log('+++++++++++++++++++++++ context 3 9: ', _context3)
          ...
          case 13:
            console.log('rA case 13')
            console.log('+++++++++++++++++++++++ context 3 13: ', _context3)
          ...
          case 15:
            console.log('rA case 15')
            console.log('+++++++++++++++++++++++ context 3 15: ', _context3)
            return _context3.abrupt('return', { authenticators: authenticators, issuer: issuer, doc: doc });

          case 16:
            console.log('rA case 16')
            console.log('+++++++++++++++++++++++ context 3 16: ', _context3)
          case 'end':
  ...
  console.log('ra regenerator finished')
...
function encodeSection(data) {
  console.log('encoding section: ', (0, _stringify2.default)(data), (0, _stringify2.default)(data[0]) )
  var result = _base64url2.default.encode((0, _stringify2.default)(data));
...
function normalizeDID(mnidOrDid) {
  console.log('normalizeDID triggered with', mnidOrDid)
