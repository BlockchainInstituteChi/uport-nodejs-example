'use strict';
console.log('uport-did-resolver ran - lib - u')
...
function register(configured) {
  console.log('~~~4 configured', configured)
  var cpsRegistry = configured || (0, _uportLite2.default)();
  console.log('~~~ cpsRegistry', cpsRegistry)
  var registry = function registry(mnid) {
    console.log('~~~ registry called for ', mnid)
    return new _promise2.default(function (resolve, reject) {
      cpsRegistry(mnid, function (error, doc) {
        console.log('~~~ cpsRegistry for ', mnid)
  ...
  function resolve(did, parsed) {
    console.log('~~~ resolve called for ', did, parsed)
    return new _promise2.default(function (resolve, reject) {
