console.log('did-resolver src ran')
const REGISTRY = {}
...
export function parse (did) {
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ did-resolver-parse ran')
...
export function resolve (did) {
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ did-resolver-resolve ran')
  return new Promise((resolve, reject) => {
    const parsed = parse(did)
    console.log('method found ', REGISTRY[parsed.method])
    const resolver = REGISTRY[parsed.method]
    console.log('~+~+~+~+~+~+~+~+~+~+~+~+~+  resolving ', resolver, 'with data', parsed)
    if (resolver) {
      console.log('resolver verified ', resolver)
